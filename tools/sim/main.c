/**
 * @file main.c
 * @brief LogicElements Desktop Simulator CLI.
 *        Runs any .lebin program in a simulated microcontroller environment.
 */
...
int main(int argc, char* argv[])
{
    ...
    {
        /* Inject sample inputs: toggle IN0 every 10 cycles, IN1 every 20 cycles */
        ...
        sim_time_ms += 10; /* 10ms per cycle = 100Hz scan rate */
    }
