...
ElementType Engine::ParseElementType(std::string& type)
{
    ...
    if (type == "ElementType::Add") return ElementType::Add;
    if (type == "ElementType::Subtract") return ElementType::Subtract;
    if (type == "ElementType::Multiply") return ElementType::Multiply;
    if (type == "ElementType::Divide") return ElementType::Divide;
    if (type == "ElementType::Negate") return ElementType::Negate;
    if (type == "ElementType::Abs") return ElementType::Abs;
    ...
    if (type == "ElementType::AddComplex") return ElementType::AddComplex;
    if (type == "ElementType::SubtractComplex") return ElementType::SubtractComplex;
    if (type == "ElementType::MultiplyComplex") return ElementType::MultiplyComplex;
    if (type == "ElementType::DivideComplex") return ElementType::DivideComplex;
    if (type == "ElementType::NegateComplex") return ElementType::NegateComplex;
    if (type == "ElementType::Magnitude") return ElementType::Magnitude;
...
Element* Engine::AddElement(ElementTypeDef* comp)
{
    ...
    case ElementType::Add:
        return this->AddElement(new Add(), compName);

    case ElementType::Subtract:
        return this->AddElement(new Subtract(), compName);

    case ElementType::Multiply:
        return this->AddElement(new Multiply(), compName);

    case ElementType::Divide:
        return this->AddElement(new Divide(), compName);

    case ElementType::Negate:
        return this->AddElement(new Negate(), compName);

    case ElementType::Abs:
        return this->AddElement(new Abs(), compName);
    ...
    case ElementType::AddComplex:
        return this->AddElement(new AddComplex(), compName);

    case ElementType::SubtractComplex:
        return this->AddElement(new SubtractComplex(), compName);

    case ElementType::MultiplyComplex:
        return this->AddElement(new MultiplyComplex(), compName);

    case ElementType::DivideComplex:
        return this->AddElement(new DivideComplex(), compName);

    case ElementType::NegateComplex:
        return this->AddElement(new NegateComplex(), compName);

    case ElementType::Magnitude:
        return this->AddElement(new Magnitude(), compName);
#endif
