...
/**
 * @brief Class representing a complex multiplication element.
 *        Multiplies two complex float inputs and outputs the result.
 */
class MultiplyComplex : public Element
{
LE_ELEMENT_ACCESS_MOD:
    /**
     * @brief Constructor that initializes the MultiplyComplex element with two inputs.
     */
    MultiplyComplex();
