...
class TcpConnectionHandler : public AbstractConnectionHandler {
public:
    /**
     * @brief Constructor for the TCP connection handler.
     * @param connection The TCP connection object.
     */
    TcpConnectionHandler(MinimalSocket::tcp::TcpConnectionBlocking& connection);
...
class SerialConnectionHandler : public AbstractConnectionHandler {
public:
    /**
     * @brief Constructor for the Serial connection handler.
     * @param connection The Serial connection object.
     */
    SerialConnectionHandler(serialib* connection);
