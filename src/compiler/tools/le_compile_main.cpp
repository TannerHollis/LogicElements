/**
 * @file le_compile_main.cpp
 * @brief Standalone command-line compiler driver executable for LogicElements.
 */
...
int main(int argc, char* argv[])
{
    ...
    // Default output path if neither output binary nor header specified
    ...
    // Read board profile if specified
    ...
    // Write disassembly if requested
